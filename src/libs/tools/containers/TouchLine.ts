import { Container, Graphics, ILineStyleOptions, LINE_JOIN, LINE_CAP } from 'pixi.js';
  ...
  public makeLine(type: number, indexOf: number, reverse: boolean = false): void {
    ...
    if (type === 0) {
      ...
      if (reverse) {
        ...
        newLine.lineStyle(LS).arc(W * 1.05, W * 0.04, W, (P * 154.8) / 180, (P * radian) / 180); //P * 25.2 / 180
      } else {
        const radian: number = 180 - (25.2 * count) / 5;
        newLine.lineStyle(LS).arc(W * 1.05, W * 0.04, W, (P * 180) / 180, (P * radian) / 180, true); //P * 25.2 / 180
      }
    } else if (type === 1) {
      //MAX : 5
      const count: number = Math.min(indexOf, 5);
      ...
      if (reverse) {
        ...
        newLine.lineStyle(LS).arc(-W * 0.65, -W * 0.14, W, (P * 11) / 180, (P * radian) / 180); //P * 26.2 / 180
      }
    } else if (type === 2) {
      //MAX : 5
      const count: number = Math.min(indexOf, 5);
      ...
      if (reverse) {
        ...
        newLine.lineStyle(LS).arc(W * 1.65, -W * 0.14, W, (P * 142.8) / 180, (P * radian) / 180); //P * 26.2 / 180
      } else {
      ...
      if (reverse) {
        ...
        newLine.lineStyle(LS).arc(-W * 0.05, W * 0.04, W, 0, (P * radian) / 180); //P * 25.2 / 180
      }
    } else if (type === 4) {
      //MAX : 7
      ...
      if (reverse) {
        ...
        newLine.lineStyle(LS).arc(W * 0.9715, -W * 0.3515, W, (P * 118) / 180, (P * radian) / 180); //P * 39.1 / 180
      } else {
      ...
      if (reverse) {
        ...
        newLine.lineStyle(LS).arc(W * 0.0285, -W * 0.3515, W, (P * 22.9) / 180, (P * radian) / 180); //P * 39.1 / 180
      }
    } else if (type === 6) {
      //MAX : 4
      ...
      if (reverse) {
        ...
        newLine.lineStyle(LS).arc(W * 0.5, -W * 0.469, W, (P * 90) / 180, (P * radian) / 180); //P * 20.8 / 180
      } else {
      ...
      if (reverse) {
        const radian: number = 90 - (20.8 * count) / 4;
        newLine.lineStyle(LS).arc(W * 0.5, -W * 0.469, W, (P * 90) / 180, (P * radian) / 180, true); //P * 20.8 / 180
      } else {
        const radian: number = 69.2 + (20.8 * count) / 4;
        newLine.lineStyle(LS).arc(W * 0.5, -W * 0.469, W, (P * 69.2) / 180, (P * radian) / 180); //P * 20.8 / 180
      }
    }
    newLine.alpha = 0;
