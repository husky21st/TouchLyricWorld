...
export class LoadingGame extends Container {
  ...
  constructor() {
    ...
    this.spaceLine = new Graphics().lineStyle(LS).moveTo(100, 400).lineTo(1500, 400);
    this.addChild(this.spaceLine);

    this.explainJP1 = new BitmapText('歌詞が線のところまで来たらタイミング良くなぞろう！', {
    ...
    this.explainJP2 = new BitmapText('ビートに合わせて', {
      fontName: 'BasicRocknRoll',
      tint: 0x000000,
      fontSize: 48,
    });
    ...
    this.explainJP3 = new BitmapText('スペースキーを押すと / 他の指で画面をタップすると', {
      fontName: 'BasicRocknRoll',
      tint: 0x000000,
      fontSize: 48,
    });
    ...
    this.explainJP4 = new BitmapText('得点アップ！', {
      fontName: 'BasicRocknRoll',
      tint: 0x000000,
      fontSize: 48,
    });
    ...
    this.explainEN1 = new BitmapText(
      'When the lyrics come to the line, trace them with good timing!',
      { fontName: 'BasicRocknRoll', tint: 0x000000, fontSize: 42 },
    );
    this.explainEN1.anchor.set(0.5);
    this.explainEN1.position.set(800, 450);
    this.addChild(this.explainEN1);

    this.explainEN2 = new BitmapText('Press the spacebar / Tap the screen with your other finger', {
      fontName: 'BasicRocknRoll',
      tint: 0x000000,
      fontSize: 42,
    });
    ...
    this.explainEN3 = new BitmapText('on the beat to increase your score!', {
      fontName: 'BasicRocknRoll',
      tint: 0x000000,
      fontSize: 42,
    });
    ...
    this.loadingText = new BitmapText('Loading', {
      fontName: 'BasicRocknRoll',
      tint: 0x000000,
      fontSize: 64,
    });
    ...
    this.startButton = new BitmapText('> Start <', {
      fontName: 'BasicRocknRoll',
      tint: 0x000000,
      fontSize: 64,
    });
