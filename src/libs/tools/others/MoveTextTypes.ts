...
export class MoveTextTypes {
  ...
  private moveTextType0(
    ...
    this._MoveLyricText.moveTextBasic(
      charTextBox,
      Duration,
      radian,
      { x: 0.5, y: -0.05 },
  ...
  public movePhraseText(
    phraseTextBox: PhraseInfo,
    beatDuration: number,
    _TouchLine: TouchLine,
  ): void {
